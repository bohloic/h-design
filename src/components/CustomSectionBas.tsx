      ...
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-24 lg:py-32">
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-24">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center">
            <span className="text-sm font-semibold tracking-widest text-indigo-600 uppercase mb-4">
              Exclusivité Studio
            </span>
            <h2 className="text-3xl lg:text-5xl font-extrabold text-gray-900 mb-6 leading-tight uppercase">
              Personnalisation de <span className="text-indigo-600">qualité</span>
            </h2>
              ...
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <img 
                    ...
                    alt="Utilisateur content" 
                  />
                ))}
              </div>
              <p className="text-sm text-gray-500 italic">
                Déjà plus de 10,000 créations uniques réalisées cette année.
              </p>
            </div>
          </div>
        </div>
