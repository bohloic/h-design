...
export const LoyaltyTab = () => {
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            {/* EN-TÊTE */}
            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-slate-100 flex items-center gap-4">
                {/* 🪄 COULEURS DYNAMIQUES */}
                <div 
                ...
                <div>
                    <h2 className="text-2xl font-black text-slate-900 tracking-tight">Club Privilège H-Designer</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                    <h3 className="font-bold text-lg text-slate-800 mb-4">Comment ça marche ?</h3>
                    
                    <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
                        <div className="bg-slate-50 p-3 rounded-xl text-slate-600"><ShoppingBag size={20} /></div>
                        <div>
                            <h4 className="font-bold text-slate-800">1. Collectionnez</h4>
                    ...
                    <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
                        <div className="bg-slate-50 p-3 rounded-xl text-slate-600"><TrendingUp size={20} /></div>
                        <div>
                            <h4 className="font-bold text-slate-800">2. Suivez votre jauge</h4>
                    ...
                    <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
                        ...
                        <div>
                            <h4 className="font-bold text-slate-800">3. La Récompense</h4>
